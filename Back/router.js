...
const controller_intern = require('./controller/con_employee_intern_data');
const controller_permanent = require('./controller/con_employee_permanent_data');
const controller_salary = require('./controller/con_employee_intern_salary');
const controller_attendance = require('./controller/con_employee_attendance');
const controller_final_att = require('./controller/con_employee_intern_final_att');
