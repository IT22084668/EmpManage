...
export const getEmployee_intern = () => {
  return Axios.get('http://localhost:3001/api/getEmployee_intern')
...
export const addEmployee_intern = (data) => {
    ...
    return Axios.post('http://localhost:3001/api/addEmployee_intern', payload)
      .catch(error => {
        console.error("Axios error:", error);
        throw error;
      });
...
export const deleteEmployee_intern = async (nic) => {
  try {
      await Axios.delete(`http://localhost:3001/api/deleteEmployee_intern/${nic}`);
...
export const updateEmployee_intern = async (data) => {
  try {
      ...
      const response = await Axios.post('http://localhost:3001/api/updateEmployee_intern', data);
