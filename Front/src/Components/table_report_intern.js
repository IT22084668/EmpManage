                ...
                <table className="table-fill">
                    <thead>
                        <tr>
                            ...
                            <th className="text-left">OT hours</th>
                            <th className="text-left">Monthly Salary</th>
                        </tr>
                    </thead>
                    <tbody className="table-hover">
                        {uniqueNic.map((nic, index) => {
                            ...
                            return (
                                <tr key={index}>
                                    <td className="text-left">{rowDataForNIC.length > 0 ? rowDataForNIC[0].name : ''}</td>
                                    <td className="text-left">{nic}</td>
                                    <td className="text-left">{rowDataForSelectedMonth ? rowDataForSelectedMonth.att : '0'}</td>
                                    <td className="text-left">{rowDataForSelectedMonth ? rowDataForSelectedMonth.ot : '0'}</td>
                                    <td className="text-left">{renderSalary(nic,selectedMonth)}</td>
                                </tr>
                            );
                        })}
                    </tbody>
